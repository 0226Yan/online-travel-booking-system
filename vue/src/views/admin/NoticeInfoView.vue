<template>
  <div>
    <div style="margin-top: 10px">
      <el-input v-model="params.noticeName" style="width: 200px; margin-left: 240px"
                class="name_input" placeholder="请输入公告标题"></el-input>
    ...
    <div style="margin-left: 240px;margin-top: 30px">
      ...
      <el-table
          ...
          style="width: 100%; ">
        <el-table-column prop="noticeId"   label="序号"   align="center"></el-table-column>
        <el-table-column prop="noticeName" label="公告标题"  align="center"></el-table-column>
        ...
        <el-table-column label="操作" align="center">
          <template slot-scope="scope">
            ...
            <el-popconfirm title="确定删除吗？" @confirm="del(scope.row.noticeId)">
    ...
    <div>
      ...
      <el-dialog :visible.sync="dialogFormVisible" width="30%"  :modal-append-to-body="false">
        ...
        <el-form :model="form" >
          <el-form-item label="公告标题" label-width="20%" label-align="left">
            <el-input v-model="form.noticeName" autocomplete="off" style="width: 90%"></el-input>
          </el-form-item>
...
export default {
  ...
  methods: {
    ...
    submit() {
      request.post("/noticeInfo",this.form).then(res => {
        if (res.code === '0') {
          this.$message({
            message: '操作成功',
            type: 'success'
    ...
    del(noticeId) {
      request.delete("/noticeInfo/" + noticeId).then(res => {
        if(res.code === '0') {
          this.$message({
            message: '删除成功',
            type: 'success'
