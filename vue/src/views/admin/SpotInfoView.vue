<template>
  <div>
    <div style="margin-top: 10px">
      <el-input v-model="params.spotName" style="width: 200px; margin-left: 240px"
                class="name_input" placeholder="请输入景点名称"></el-input>
      <el-input v-model="params.spotAddress" style="width: 200px; margin-left: 5px"
                class="address_input" placeholder="请输入景点地址"></el-input>
    ...
    <div style="margin-left: 240px;margin-top: 30px" class="spot_table">
      <!--表单-->
      <el-table
          :data="tableData"
          :header-cell-style="{color: '#323335',fontSize: '14px', backgroundColor: '#F0F0F0'}"
          style="width: 100%; ">
        <el-table-column prop="spotId"       label="序号"     align="center" :width="50"></el-table-column>
        <el-table-column label="景点图片"  align="center" >
        ...
        <el-table-column prop="spotAddress"  label="景点地址"  align="center"></el-table-column>
        <el-table-column prop="description"  label="简介"     align="center" :width="300"></el-table-column>
        <el-table-column prop="openingHours" label="开放时间"  align="center" :width="105"></el-table-column>
        <el-table-column prop="price"        label="票价"     align="center" :width="80"></el-table-column>
        <el-table-column prop="amount"       label="余票"     align="center" :width="80"></el-table-column>
        ...
        <el-table-column label="操作" align="center">
          <template slot-scope="scope">
            ...
            <el-popconfirm title="确定删除吗？" @confirm="del(scope.row.spotId)">
    ...
    <div>
      ...
      <el-dialog :visible.sync="dialogFormVisible" width="60%"  :modal-append-to-body="false">
        ...
        <el-form :model="form" >
          <el-form-item label="景点名称" label-width="20%" label-align="left">
            <el-input v-model="form.spotName" autocomplete="off" style="width: 90%"></el-input>
          </el-form-item>
          <el-form-item label="景点地址" label-width="20%">
            <el-input v-model="form.spotAddress" autocomplete="off" style="width: 90%"></el-input>
          </el-form-item>
          <el-form-item label="景点图片" label-width="20%">
            <el-upload
          ...
          <el-form-item label="开放时间" label-width="20%">
            <el-input v-model="form.openingHours" autocomplete="off" style="width: 90%"></el-input>
          </el-form-item>
...
export default {
  ...
  methods: {
    ...
    submit() {
      request.post("/spotInfo",this.form).then(res => {
        if (res.code === '0') {
    ...
    del(spotId) {
      request.delete("/spotInfo/" + spotId).then(res => {
        if(res.code === '0') {
