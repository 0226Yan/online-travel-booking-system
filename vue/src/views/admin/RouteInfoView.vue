<template>
  <div>
    <div style="margin-top: 10px">
      <el-input v-model="params.tourName" style="width: 200px; margin-left: 240px"
                class="name_input" placeholder="请输入线路名称"></el-input>
      <el-input v-model="params.deptDate" style="width: 200px; margin-left: 5px"
                class="name_input" placeholder="请输入出发日期"></el-input>
    ...
    <div style="margin-left: 240px;margin-top: 30px" class="route_table">
      <!--表单-->
      <el-table
          :data="tableData"
          :header-cell-style="{color: '#323335',fontSize: '14px', backgroundColor: '#F0F0F0'}"
          style="width: 100%; ">
        <el-table-column prop="tourId"         label="序号"      align="center" :width="50"></el-table-column>
        <el-table-column label="图片"  align="center" >
          <template v-slot="scope">
            <el-image
                style="width: 80px; height: 80px; border-radius: 50%"
                :src="'http://localhost:8080/api/files/' + scope.row.img"
                :preview-src-list="['http://localhost:8080/api/files/' + scope.row.spotimg]">
            </el-image>
          </template>
        </el-table-column>
        <el-table-column prop="tourName"       label="线路名称"   align="center"></el-table-column>
        <el-table-column prop="tourDesc"       label="线路描述"   align="center"></el-table-column>
        <el-table-column prop="dept"           label="出发地"     align="center"></el-table-column>
        <el-table-column prop="deptDate"       label="出发日期"   align="center"></el-table-column>
        <el-table-column prop="days"           label="天数"      align="center"></el-table-column>
        <el-table-column prop="price"          label="价格"      align="center"></el-table-column>
        <el-table-column prop="amount"         label="剩余名额"   align="center"></el-table-column>
        ...
        <el-table-column label="操作" align="center">
          <template slot-scope="scope">
            ...
            <el-popconfirm title="确定删除吗？" @confirm="del(scope.row.tourId)">
    ...
    <div>
      ...
      <el-dialog :visible.sync="dialogFormVisible" width="60%"  :modal-append-to-body="false">
        ...
        <el-form :model="form" >
          <el-form-item label="线路名称" label-width="20%" label-align="left">
            <el-input v-model="form.tourName" autocomplete="off" style="width: 90%"></el-input>
          </el-form-item>
          ...
          <el-form-item label="线路描述" label-width="20%">
            <el-input type="textarea" v-model="form.tourDesc" autocomplete="off" style="width: 90%"></el-input>
          </el-form-item>
          <el-form-item label="出发地" label-width="20%">
            <el-input v-model="form.dept" autocomplete="off" style="width: 90%"></el-input>
          </el-form-item>
          <el-form-item label="出发日期" label-width="20%">
            <el-input v-model="form.deptDate" autocomplete="off" style="width: 90%"></el-input>
          </el-form-item>
          <el-form-item label="天数" label-width="20%">
            <el-input v-model="form.days" autocomplete="off" style="width: 90%"></el-input>
          </el-form-item>
          <el-form-item label="价格" label-width="20%">
            <el-input v-model="form.price" autocomplete="off" style="width: 90%"></el-input>
          </el-form-item>
          <el-form-item label="剩余名额" label-width="20%">
...
export default {
  ...
  methods: {
    ...
    submit() {
      request.post("/routeInfo",this.form).then(res => {
        if (res.code === '0') {
          this.$message({
            message: '操作成功',
            type: 'success'
    ...
    del(tourId) {
      request.delete("/routeInfo/" + tourId).then(res => {
        if(res.code === '0') {
          this.$message({
            message: '删除成功',
            type: 'success'
