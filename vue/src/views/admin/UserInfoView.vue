...
<!--      <el-button type="info" plain icon="el-icon-plus"  class="add_button"
    ...
    <div style="margin-left: 240px;margin-top: 30px">
      ...
      <el-table
          ...
          style="width: 100%; ">
        <el-table-column prop="userId"  label="序号"   align="center" :width="50"></el-table-column>
        <el-table-column label="头像"   align="center">
          <template v-slot="scope">
            <el-image
                style="width: 60px; height: 60px; border-radius: 50%"
                :src="'http://localhost:8080/api/files/' + scope.row.userImg"
                :preview-src-list="['http://localhost:8080/api/files/' + scope.row.userImg]">
            </el-image>
          </template>
        </el-table-column>
